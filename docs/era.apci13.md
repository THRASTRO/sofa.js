...
```js
[astrom, pmt, eb, eh, em, v, bm1, bpn, along, xpl, ypl, sphi, cphi, diurab, eral, refa, refb, eo] = ERFA.apci13(date1, date2)
```
...
3) In cases where the caller wishes to supply his own Earth
   ephemeris and CIP/CIO, the function [eraApci][1] can be used instead
