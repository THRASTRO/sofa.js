...
```js
[rv, aob, zob, hob, dob, rob] = ERFA.atio13(ri, di, utc1, utc2, dut1, elong, phi, hm, xp, yp, phpa, tc, rh, wl)
```
...
10) The complementary functions [eraAtio13][3] and [eraAtoi13][4] are self-
