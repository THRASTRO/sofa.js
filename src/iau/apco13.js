function iauApco13(utc1, utc2, dut1, elong, phi, hm, xp, yp, phpa, tc, rh, wl)
/*
**  - - - - - - - - - -
**   i a u A p c o 1 3
**  - - - - - - - - - -
...
/* UTC to other time scales. */
   j = ~~((_rv1 = iauUtctai(utc1, utc2))[0]);
   tai1 = _rv1[1];
   tai2 = _rv1[2];
   if ( j < 0 ) return [ -1, astrom, eo ];
   j = ~~((_rv2 = iauTaitt(tai1, tai2))[0]);
   tt1 = _rv2[1];
   tt2 = _rv2[2];
   j = ~~((_rv3 = iauUtcut1(utc1, utc2, dut1))[0]);
   ut11 = _rv3[1];
   ut12 = _rv3[2];
   if ( j < 0 ) return [ -1, astrom, eo ];

/* Earth barycentric & heliocentric position/velocity (au, au/d). */
   (_rv4 = iauEpv00(tt1, tt2))[0];
   ehpv = _rv4[1];
   ebpv = _rv4[2];
...
/* Refraction constants A and B. */
   (_rv10 = iauRefco(phpa, tc, rh, wl))[0];
   refa = _rv10[0];
   refb = _rv10[1];

/* Compute the star-independent astrometry parameters. */
   astrom = iauApco(tt1, tt2, ebpv, ehpv[0], x, y, s, theta, elong, phi, hm, xp, yp, sp, refa, refb);
