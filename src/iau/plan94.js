function iauPlan94(date1, date2, np)
/*
**  - - - - - - - - - -
**   i a u P l a n 9 4
**  - - - - - - - - - -
...
/* Maximum number of iterations allowed to solve Kepler's equation */
   ...
   var jstat, i, k;
   var t, da, dl, de, dp, di, dom, dmu, arga, argl, am, ae, dae, ae2, at, r, v, si2, xq, xp, tl, xsw, xcw, xm2, xf, ci2, xms, xmc, xpxq2, x, y, z;

/* Planetary inverse masses */
   var                 amas = [ 6023600.0,       /* Mercury */
                                   408523.5,       /* Venus   */
                                   328900.5,       /* EMB     */
                                  3098710.0,       /* Mars    */
                                     1047.355,     /* Jupiter */
