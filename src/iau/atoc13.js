function iauAtoc13(type, ob1, ob2, utc1, utc2, dut1, elong, phi, hm, xp, yp, phpa, tc, rh, wl)
/*
**  - - - - - - - - - -
**   i a u A t o c 1 3
**  - - - - - - - - - -
...
/* Star-independent astrometry parameters. */
   j = ~~((_rv1 = iauApco13(utc1, utc2, dut1, elong, phi, hm, xp, yp, phpa, tc, rh, wl))[0]);
   astrom = _rv1[1];
   eo = _rv1[2];

/* Abort if bad UTC. */
   if ( j < 0 ) return [ j, rc, dc ];

/* Transform observed to CIRS. */
   (_rv2 = iauAtoiq(type, ob1, ob2, astrom))[0];
   ri = _rv2[0];
   di = _rv2[1];

/* Transform CIRS to ICRS. */
   (_rv3 = iauAticq(ri, di, astrom))[0];
   rc = _rv3[0];
   dc = _rv3[1];
